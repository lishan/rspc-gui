...
app.factory('NgTableParams', ['$q', '$log', 'ngTableDefaults', function($q, $log, ngTableDefaults) {
    ...
    var NgTableParams = function(baseParameters, baseSettings) {
        ...
        this.generatePagesArray = function(currentPage, totalItems, pageSize) {
            ...
            maxBlocks = 11;
            pages = {};
            pages.numPages = Math.ceil(totalItems / pageSize);
            pages.currentPage=currentPage;
            pages.totalItems=totalItems;
        ...
        return {
            ...
            link: function(scope, element, attrs) {
                ...
                scope.goPage=function(pageNum){
                     if(scope.pages){
                         if(pageNum>=1&&pageNum<=scope.pages.numPages){
...
angular.module('ngTable').run(['$templateCache', function ($templateCache) {
	...
	$templateCache.put('ng-table/header.html', '<tr class="table-title lb-tit"><th title="{{$column.headerTitle(this)}}" ng-repeat="$column in $columns" ng-class="{ \'sortable\': $column.sortable(this), \'sort-asc\': params.sorting()[$column.sortable(this)]==\'asc\', \'sort-desc\': params.sorting()[$column.sortable(this)]==\'desc\' }" ng-click="sortBy($column, $event)" ng-show="$column.show(this)" ng-init="template=$column.headerTemplateURL(this)" class="header {{$column.class(this)}}"> <div ng-if="!template" ng-show="!template" class="ng-table-header" ng-class="{\'sort-indicator\': params.settings().sortingIndicator==\'div\'}"> <span ng-bind="$column.title(this)" ng-class="{\'sort-indicator\': params.settings().sortingIndicator==\'span\'}"></span> </div> <div ng-if="template" ng-show="template" ng-include="template"></div> </th> </tr> <tr ng-show="show_filter" class="ng-table-filters"> <th data-title-text="{{$column.titleAlt(this) || $column.title(this)}}" ng-repeat="$column in $columns" ng-show="$column.show(this)" class="filter"> <div ng-repeat="(name, filter) in $column.filter(this)"> <div ng-if="filter.indexOf(\'/\') !==-1" ng-include="filter"></div> <div ng-if="filter.indexOf(\'/\')===-1" ng-include="\'ng-table/filters/\' + filter + \'.html\'"></div> </div> </th> </tr><tr class="lb-jgx1"><td></td> <td></td> <td></td> <td></td><td></td></tr> ');

    //var pageTem1= '<div class="ng-cloak ng-table-pager" > {{pages}}<div ng-if="params.settings().counts.length" class="ng-table-counts btn-group pull-right"> <button ng-repeat="count in params.settings().counts" type="button" ng-class="{\'active\':params.count()==count}" ng-click="params.count(count)" class="btn btn-default"> <span ng-bind="count"></span> </button> </div> <ul class="pagination ng-table-pagination"> <li ng-class="{\'disabled\': !page.active && !page.current, \'active\': page.current}" ng-repeat="page in pages" ng-switch="page.type"> <a ng-switch-when="prev" ng-click="params.page(page.number)" href="">&laquo;</a> <a ng-switch-when="first" ng-click="params.page(page.number)" href=""><span ng-bind="page.number"></span></a> <a ng-switch-when="page" ng-click="params.page(page.number)" href=""><span ng-bind="page.number"></span></a> <a ng-switch-when="more" ng-click="params.page(page.number)" href="">&#8230;</a> <a ng-switch-when="last" ng-click="params.page(page.number)" href=""><span ng-bind="page.number"></span></a> <a ng-switch-when="next" ng-click="params.page(page.number)" href="">&raquo;</a> </li> </ul> </div>';
    var pageTem= '<div class="kolfy clearfix"><div class="jupmpage clearfix">'+
    '<p> 每页&nbsp;<button ng-repeat="count in params.settings().counts" type="button" ng-class="{\'active\':params.count()==count}" ng-click="params.count(count)" class="btn btn-default"> <span ng-bind="count"></span> </button> 当前第{{pages.currentPage}}页/{{pages.numPages}}页 总数{{pages.totalItems}}' +
        '</p> <ul class=" clearfix">'+
    '<li><a ng-class="{\'jupmpage1\':pages.currentPage!=1,\'jupmpage1-nh\':pages.currentPage==1}" ng-click="goPage(1)" href=""></a></li>'+
    '<li><a ng-class="{\'jupmpage2\':pages.currentPage!=1,\'jupmpage2-nh\':pages.currentPage==1}" ng-click="goPage(pages.currentPage-1)" href=""></a></li>'+
    '<li><a ng-class="{\'jupmpage3\':pages.currentPage!=pages.numPages,\'jupmpage3-nh\':pages.currentPage==pages.numPages}" ng-click="goPage(pages.currentPage+1)" href=""></a></li>'+
    '<li><a ng-class="{\'jupmpage4\':pages.currentPage!=pages.numPages,\'jupmpage4-nh\':pages.currentPage==pages.numPages}" ng-click="goPage(pages.numPages)" href=""></a></li>'+
    '</ul> </div></div>';
    $templateCache.put('ng-table/pager.html',pageTem);
}]);
    return app;
}));